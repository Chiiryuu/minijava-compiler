...
public class TableBuilder<R, A> implements GJVisitor<R, A> {
   ...
   //Add Variable
   public boolean addEntry(A argu, String newEntry, String type) {
      if (argu instanceof SymbolTable) {
         ...
         if (table.table.containsKey(symbolTitle)) {
            throwTypeError();
         }
         TokenEntry newToken = new TokenEntry(symbolTitle,newEntry,type);
         table.table.put(symbolTitle,newToken);
         return true;
      }
      return true;
   }
   ...
   //Add Method
   public boolean addEntry(A argu, String newEntry, String type, String returnType, String[] inputs) {
      if (argu instanceof SymbolTable) {
         SymbolTable table = ((SymbolTable)(argu));
         String symbolTitle = table.scope;
         if (symbolTitle.length()>0)
         ...
         TokenEntry newToken = new TokenEntry(symbolTitle,newEntry,"Method");
         newToken.returnType = returnType;
         newToken.inputs = inputs;
         table.table.put(symbolTitle,newToken);
         return true;
      }
      return true;
   ...
   //Add Class
   public boolean addEntry(A argu, String newEntry, String type, String inherit) {
      if (argu instanceof SymbolTable) {
         SymbolTable table = ((SymbolTable)(argu));
         String symbolTitle = table.scope;
         if (symbolTitle.length()>0)
   ...
   public R visit(MainClass n, A argu) {
      ...
      addEntry(argu,"main","Method","Void",new String[]{"String[]"});
      constrict(argu,"main");
      addEntry(argu,argsName,"String[]");
   ...
   public R visit(MethodDeclaration n, A argu) {
      ...
      if (inputs == null)
         addEntry(argu,name,"Method",returnType,new String[]{});
      else
         addEntry(argu,name,"Method",returnType,inputs.split(","));

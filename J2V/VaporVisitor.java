...
public class VaporVisitor implements GJVisitor<String,SymbolTable> {
   ...
   public String doBinop(String lhs, String rhs, String op, String leftVar, String rightVar, String var) {
   ...
   public String visit(PlusExpression n, SymbolTable argu) {
      ...
      String var = getNewTempName();
      argu.lastTemp=var;
      return doBinop(expr1,expr2,"Add", var1, var2, var);
   }
   ...
   public String visit(MinusExpression n, SymbolTable argu) {
      ...
      String var = getNewTempName();
      argu.lastTemp=var;
      return doBinop(expr1,expr2,"Sub", var1, var2, var);
   }
   ...
   public String visit(TimesExpression n, SymbolTable argu) {
      ...
      String var = getNewTempName();
      argu.lastTemp=var;
      return doBinop(expr1,expr2,"MulS", var1, var2, var);
   }
